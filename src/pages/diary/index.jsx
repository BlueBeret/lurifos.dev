...
export default function Index(props) {
    ...
    const search = (e) => {
        ...
        fetch('/api/diary/search?search=' + searchQuery).then(res => res.json()).then(
            data => {
    ...
    return (
        <div className="content-container items-center fillheight">
            <form className="search-bar h-[35px] w-[90%] flex flex-row justify-center" onSubmit={search}>
                ...
                <button type='submit' className="searchbutton bg-sred h-full shadow-xl rounded-r-full pl-2 pr-3 hover:cursor-pointer" ><FaSearch className="text-white h-full" /></button>
            </form>
